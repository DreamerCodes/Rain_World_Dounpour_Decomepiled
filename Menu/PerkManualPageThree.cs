...
public class PerkManualPageThree : ManualPage
{
	public FSprite headingSeparator;

	public FSprite[] sprites;

	public PerkManualPageThree(Menu menu, MenuObject owner)
		: base(menu, owner)
	{
		...
		{
			string key = ExpeditionProgression.perkGroups["moreslugcats"][i];
