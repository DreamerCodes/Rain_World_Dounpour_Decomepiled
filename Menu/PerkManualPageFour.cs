...
public class PerkManualPageFour : ManualPage
{
	public FSprite headingSeparator;

	public FSprite[] sprites;

	public PerkManualPageFour(Menu menu, MenuObject owner)
		: base(menu, owner)
	{
		...
		{
			string key = ExpeditionProgression.perkGroups["moreslugcats"][4 + i];
